...
export default async function NewsPage() {
  ...
  try {
    const chairmanRes = await fetch("https://nationalbiomed.com.np/api/team/get/chairman", { cache: "force-cache" });
    if (chairmanRes.ok) {
  ...
  try {
    const teamRes = await fetch("https://nationalbiomed.com.np/api/team/makecategory", { cache: "force-cache" });
    if (teamRes.ok) {
