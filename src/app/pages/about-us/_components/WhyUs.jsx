        ...
        <Card className="bg-gradient-to-r from-green-400 from-10% via-emerald-300 via-30% to-green-100 to-90% absolute xl:-top-[10%] -top-[13%]  lg:left-[-20%] left-0  lg:rounded-full rounded-none lg:w-[60%]  w-full aspect-square  mt-[50px]  flex justify-center items-center flex-row">
          <div className="grid lg:grid-cols-2  grid-cols-1  ">
            ...
            <div className=" grid grid-cols-1 justify-items-end  space-y-20  ">
              <div className=" w-[60px] h-[60px] rounded-full bg-green-600 -mr-2  flex justify-center items-center  shadow-2xl shadow-black">
              ...
              <div className=" w-[60px] h-[60px] rounded-full bg-green-600 -mr-6  flex justify-center items-center  shadow-2xl shadow-black">
