...
export default function Description(){
    return(
       ...
       {CategotyDescription.map((items)=>(
         ...
         <div className="bg-green-100  md:p-7 p-5 md:absolute md:w-[40%] w-[100%] md:top-1/2 md:left-[45%] md:transform md:-translate-y-1/2 md:h-[70%] overflow-hidden" key={items.id}>
        <h1 className="md:text-2xl text-xl text-green-700 font-bold pb-2">{items.title}</h1>
        <p className="md:text-base text-sm">{items.description}</p>
       </div>
         ))}
