...
export default function Products() {
  return (
    <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 gap-5 items-center pb-10 " data-aos="fade-up"> 
    {ProductList.map((items)=>(
        
   
          <a href={items.href} className=" flex flex-col items-center group mb-10" key={items.id}>
