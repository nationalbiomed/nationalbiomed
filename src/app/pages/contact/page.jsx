      ...
      <div className="container max-w-7xl mx-auto px-4">
        <div className="mb-14 text-center">
          ...
          <p className="text-lg text-gray-600">
            We'd love to assist you. Fill out the form or reach out through other channels.
          </p>
        </div>
          ...
          <div className="rounded-lg bg-white p-8 shadow-lg">
            <form action={handleSubmit}>
              ...
              <div className="mb-6">
                ...
                />
                {state?.error?.message && (
                  <p className="mt-1 text-sm text-red-500">{state.error.message[0]}</p>
                )}
              </div>
              ...
              {state?.error?.agreeToTerms && (
                <p className="mb-4 text-sm text-red-500">{state.error.agreeToTerms[0]}</p>
              )}
            ...
            {state?.success && (
              <p className="mt-4 text-green-600 text-center">Thank you for your message. We'll be in touch soon!</p>
            )}
          </div>
        </div>
        <div className="mt-16">
          <h2 className="mb-4 text-2xl font-bold text-gray-900">Our Location</h2>
          <iframe
...
const FormField = ({ label, name, type, placeholder, error }) => (
  <div>
    <Label htmlFor={name}>
      {label}<sup className="ml-0.5 text-red-500">*</sup>
    </Label>
    <Input
      type={type}
      id={name}
