    ...
    return(
        <div className="relative mb-[100px] overflow-hidden">
            ...
            <Card className="absolute md:w-[30%] w-[100%] top-[50%] translate-y-[-50%] bg-white opacity-65 flex justify-end rounded-l-none">
                ...
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nihil, provident. Nostrum rem sint vel itaque corrupti voluptatem aspernatur facilis excepturi rerum. Ullam modi deserunt molestiae eligendi aliquid nulla quas reiciendis.</p>
                </div>
            </Card>
        </div>
    )
